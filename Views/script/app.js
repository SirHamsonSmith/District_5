...
$(document).on('click', '#reply-btn-comment', function () {
    ...
    discussion = $('textarea#text-reply').val()
                        ...
                        .then(r2 => {
                            ...
                            fetch(`/votes/${topic}`)
                                ...
                                .then(r2 => {
                                    ...
                                    const upvoteCount = votes.filter(v => v.upvote).length;
                                    const downvoteCount = votes.filter(v => v.downvote).length;
                                    $(this).parent().append(`
                           <hr>
                <div>
                    <table>
                    ...
                    <div id="reply-reply">
                        <i id="t-up" class="fa fa-thumbs-up space thumbs thumbs-up" aria-hidden="true">(${upvoteCount})</i>
                        <i id="t-down" class="fa fa-thumbs-down space thumbs" aria-hidden="true">(${downvoteCount})</i>
